...
<body>
  ...
  <div class="pricing-table">
      <h3 class="pricing-title">Unflavored Capsules</h3>
      <div class="price">40$<sup>/ Per Pack</sup></div>
      <ul class="table-list">
          <form action="#" method="POST">
          <li>1 000 <span>Capsules</span></li>
          <li>7 <span>Day Delivery</span></li>
          <li>Enter Quantity: <span><input type="text"  name="unflavoredCaps"></span></li>
      </ul>
      <div class="table-buy">
...
<div class="location">
  ...
  <div class="fullpurchase">
      <img src="image/product2.jpg" alt="picture of first product" class="prod1">
  </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $unflavoredCapsQuantity = $_POST['unflavoredCaps'];


	if($unflavoredCapsQuantity > 0){

		 
        $productName = 'UNFLAVORED BLUE CAPSULES';
        $productPrice = 40.0;
        $orderAmount =  $unflavoredCapsQuantity * $productPrice;

        $queryInsert = "INSERT INTO new_recipe (username, productName, productPrice, productQuantity, orderAmount)
    VALUES ('$getUsername', '$productName' , '$productPrice', '$unflavoredCapsQuantity', ' $orderAmount' )";
